...
- Updated Web-gui.
- Ton stratum: https://metmining.pool.com next.ton-pool.com now using mode 2 automatically again. New whalespool server wss://stratum.whalestonpool.com/stratum now using mode 6 automatically.
...
- lolMiner API now has new page /gui, which allows you to watch your rig mining in a web browser. Navigate to `http://<ip of your rig>:<apiport>/gui` 0-10GH-Port3232 in your brower doing so. 
...
- Added detection of pool not accepting worker name in <wallet.workerName>metchain:f0259ead1eb946f70f7a0d906f6c7d1eb5d27a53f750284ef77c38130e4fbd99--Kheavyhashformat when using ETHPROXY stratum. Miner will reconnect with worker name copied into --worker in this case. 
